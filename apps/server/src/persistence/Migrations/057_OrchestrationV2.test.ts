...
layer("057_OrchestrationV2", (it) => {
  ...
  it.effect("upgrades released schema 56 with one complete V2 migration", () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(migrations, [
        { migration_id: 48, name: "ClearAutomaticProjectModelDefaults" },
        { migration_id: 49, name: "Automations" },
        { migration_id: 50, name: "ProjectionProjectsAutoPull" },
        { migration_id: 51, name: "RepairAutomaticSettlementTimestamps" },
        { migration_id: 52, name: "ProjectionProjectIcon" },
