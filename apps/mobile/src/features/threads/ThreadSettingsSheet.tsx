...
function ModelRow(props: {
  ...
  const disabled = props.option.disabledReason !== undefined || props.option.isUnavailable === true;
  return (
    <Pressable
      accessibilityLabel={[props.option.label, props.option.subtitle, props.option.disabledReason]
        .filter(Boolean)
        .join(", ")}
